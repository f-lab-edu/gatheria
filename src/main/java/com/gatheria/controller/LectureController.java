...
public class LectureController {
    ...
    public ResponseEntity<Void> createLecture(
            @RequestBody LectureCreateRequestDto request, @RequestAttribute("authInfo") AuthInfo authInfo) {
    ...
    @GetMapping
    public ResponseEntity<List<LectureResponseDto>> getLectures(@RequestAttribute("authInfo") AuthInfo authInfo) {
