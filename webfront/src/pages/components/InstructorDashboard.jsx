    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md bg-white p-6 shadow-lg rounded-lg">
                ...
                <h2 className="text-2xl font-bold text-center mb-4">교수자 대시보드</h2>

                <div className="text-center space-y-4">
                    <p className="text-lg"><strong>이름:</strong> {user?.name}</p>
                    <p className="text-lg"><strong>이메일:</strong> {user?.email}</p>
                    <p className="text-lg"><strong>역할:</strong> 교수자</p>
                    <p className="text-lg"><strong>소속:</strong> {user?.affiliation}</p>
